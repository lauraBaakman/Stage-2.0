...
%General Idea
	...
	\todo[inline]{As of now incorrect and incomplete}
	\begin{equation}\label{eq:1:epanechnikovKernelWithCovarianceMatrix}
		...
		\end{cases}
	\end{equation}
	The shape of the kernel is determined based on the neighborhood of the pattern, \varPattern, whose density we are estimating. For each data point \varPattern the matrix \varCovarianceMatrix is determined according to these \todo{Stapjes, en daarna verwijzen!}
