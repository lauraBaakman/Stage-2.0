...
%General Idea
	...
	\end{equation}
	instead of \cref{eq:1:parzen} \cite{hardle2012nonparametric}. If an adaptive-width method is used the \varBandwidthMatrix is scaled with the local bandwidth. \Cref{eq:2:parzenWithBandWidthMatrix} reduces to the fixed-width Parzen estimator defined in \cref{eq:1:parzen}, if $\varBandwidthMatrix = \varBandwidth \cdot \identityMatrix{\varDim}$.
