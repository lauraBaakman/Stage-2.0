...
% Ferdosi 1/3
Dataset \numberstringnum{\ferdosiOneNum} through \numberstringnum{\ferdosiThreeNum}, shown in \crefrange{fig:3:simulated:datasets:ferdosi1}{fig:3:simulated:datasets:ferdosi3}, are taken from \textcite{ferdosi2011comparison}. They consist of a number of spherical Gaussian distributions with random noise added. The means of the Gaussian distribution are chosen in such a way that it is unlikely that the distributions overlap.istats
