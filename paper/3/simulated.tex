...
\begin{table*}
	...
	\todo[inline]{Update caption: diagonal matrix with the diagonal given by a vector}
...
\todo[inline]{Add expectations for Baakman}
...
\todo[inline]{Add Baakman in conclusion}