...
\Cref{tab:4:results:mse} presents the mean squared error of the density as estimated by the two estimators and the known density for the different datasets. Comparing the two columns in \cref{tab:4:results:mse} we find that the Modified Breiman Estimator outperforms the shape-adaptive estimator on every dataset. 
