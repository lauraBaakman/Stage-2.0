...
\begin{figure*}
	\centering
	\input{4/plots_singleSphere_subfigs}
...
% Baakman 1
	...
	\begin{figure}[!ht]
		...
		\end{subfigure}	
		\caption{Comparative plots between the true densities of dataset \baakmanOneNum as estimated by \subref{fig:results:baakman1:noOutliers:mbe} \mbe and \subref{fig:results:baakman1::noOUtliers:sambe} \sambe, with only the points whose density is estimated by \sambe to lie in $\left(\num{0.0}, \num[round-precision=1]{0.07} \right)$.}
...
% Baakman 4
	...
	\begin{figure}
		...
		\end{subfigure}	
		\caption{Comparative plots between the true densities of dataset \baakmanFourNum as estimated by \subref{fig:results:baakman4:noOutliers:mbe} \mbe and \subref{fig:results:baakman4:noOUtliers:sambe} \sambe, with only the points whose density is estimated by \sambe to lie in $\left(\num{0.0}, \num{0.15} \right)$.}
