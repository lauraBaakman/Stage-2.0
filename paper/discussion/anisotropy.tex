...
% Denser component -> higher anisotropy of kernels
	...
	\Cref{fig:discussion:anisotropy:anisotropy} illustrates the influence of the density of the Gaussian component  on the anisotropy of the kernels near the Gaussian component. \percentage{6.233289} of the points with a highly anisotropic kernel in dataset \anisotropyOne is sampled from the Gaussian component, in dataset \anisotropyTwo this is \percentage{4.161096}. Although the difference is small, this does illustrate that the density of a component, irrespective of its anisotropy, influences the anisotropy of the kernels. 
	% THE PLOT
	\begin{figure}
		\centering
		\begin{subfigure}{0.23\textwidth}
		...
		\end{subfigure}	
		\caption{Scatter plot of the data sets \subref{fig:discussion:anisotropy:anisotropy1} \anisotropyOne and \subref{fig:discussion:anisotropy:anisotropy2} \anisotropyTwo with emphasized the points whose kernels with anisotropy in the \nth{90} percentile.}
