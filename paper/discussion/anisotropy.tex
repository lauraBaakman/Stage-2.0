...
% Denser component -> higher anisotropy of kernels
	...
	\begin{figure}
		...
		\end{subfigure}	
		\caption{Scatter plot of the data sets \subref{fig:discussion:anisotropy:anisotropy1} \anisotropyOne and \subref{fig:discussion:anisotropy:anisotropy2} \anisotropyTwo with emphasized the points whose kernels have an anisotropy in the \nth{90} percentile.}
