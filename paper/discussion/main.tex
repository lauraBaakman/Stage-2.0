...
\todo[inline]{Suggest increasing K: what did the k10 experiment show?}
\todo[inline]{Suggest not always using a shape-adaptive kernel, only if the local neighbourhood has an anistropy that is greater than x.}