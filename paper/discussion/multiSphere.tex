...
% General
	...
	\begin{figure}
		...
		\caption{Low opacity scatter plot of dataset 			\subref{fig:discussion:multisphere:mbeLowerError:ferdosi3} % 
			\ferdosiTwo and \subref{fig:discussion:multisphere:mbeLowerError:baakman3} \baakmanTwo with an overlay of high opacity larger points where the absolute error of \mbe is smaller than the absolute error of \sambe.
		}
