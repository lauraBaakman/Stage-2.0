...
One of the most striking observations from \cref{s:results} is that the differences in performance between the two estimators are minimal. 
	...
	\begin{figure}
		...
		\end{subfigure}	
		\caption{Low opacity scatter plot of dataset \subref{fig:discussion:performance:mbeLowerError:ferdosi2} \ferdosiTwo and \subref{fig:discussion:performance:mbeLowerError:baakman2} \baakmanTwo with an overlay of high opacity larger points where the absolute error of \mbe is smaller than that of \sambe.}
		\label{fig:discussion:performance:two:mbeLowerError}
	\end{figure}	
	...
	\begin{figure}
		...
		\end{subfigure}	
		\caption{Low opacity scatter plot of dataset 			\subref{fig:discussion:performance:mbeLowerError:ferdosi3} % 
			\ferdosiTwo and \subref{fig:discussion:performance:mbeLowerError:baakman3} \baakmanTwo with the points where the absolute error of \mbe is smaller than the absolute error of \sambe emphasized.
		}
		\label{fig:discussion:performance:four:mbeLowerError}
	\end{figure}	
