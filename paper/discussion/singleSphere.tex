...
\todo[inline]{Near the mean: very little shape adaption, but large difference in estimated densities, if gaussian component strongly elongated: strong effect of small change due to high density of points?}