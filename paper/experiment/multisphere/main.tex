...
%General
\Cref{tab:experiment:multisphere:sets} defines the data sets that consist of a background and multiple Gaussian distributions. A scatter plot representation of these sets is shown in \cref{fig:experiment:multisphere:sets}.
	% Ferdosi 2
