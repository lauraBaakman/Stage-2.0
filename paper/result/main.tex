...
% Structure of the section
	\Cref{s:results:singleGaussian} presents the results of the data sets that contain a single Gaussian, in \cref{s:results:multipleGaussian} the results of data sets that consist of multiple Gaussian distributions embedded into a uniform random background are presented.
