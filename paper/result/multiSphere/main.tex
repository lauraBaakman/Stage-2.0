...
% ANISOTROPY
	...
	% Largest anisotropy and difference in anisotropy can be found in the points sampled from the noise. 
	...
	% GENERAL: TWO SPHERES
		...
		% BAAKMAN 2	
		% Positve correlation between sd of anistorpy of the kernels and the anisotropy of the gaussian components.	

		% FOCUS ON COMPONENTS

	% GENERAL: FOUR SPHERES
		% ANISOTROPY of kernels close, higher and more varied for B3 than for F3. 
		...
		% BAAKMAN 3
		% No positve correlation between sd of anistorpy of the kernels and the anisotropy of the gaussian components.
