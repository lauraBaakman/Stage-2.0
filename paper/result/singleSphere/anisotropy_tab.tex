...
% % WITH COMPONENTS
% \begin{tabular}{@{}c
% 	S[table-format=1.3, scientific-notation=fixed, fixed-exponent=0]S
% 	S[table-format=1.3, scientific-notation=fixed, fixed-exponent=0]S
% 	S[table-format=1.3, scientific-notation=fixed, fixed-exponent=0]S@{}}
% \toprule
% Set 		& \multicolumn{2}{c}{~} 	& \multicolumn{2}{c}{Gaussian (\legendComponentOne)} 	& \multicolumn{2}{c}{Noise (\legendComponentNoise)} \\
...
\begin{tabular}{@{}c*{3}{c}@{}}
\toprule
~			& Full Set 												& Gaussian (\legendComponentOne) 						& Noise (\legendComponentNoise) \\
\midrule
%
