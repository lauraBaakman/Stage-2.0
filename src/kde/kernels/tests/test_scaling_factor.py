...
class TestScaling_factor(TestCase):
    ...
    def _scaling_factor_01_auxiliary(self, dimension, implementation):
        ...
        actual = implementation(local_bandwidth=local_bandwidth,
                                general_bandwidth=h,
