...
class Parzen(object):
    ...
    def __init__(self, window_width, estimator_implementation=None, *args, **kwargs):
        """ Init method of the Parzen EstimatorImplementation with a Gaussian kernel.
...
class Parzen_Python(object):
    """Implementation of the Parzen EstimatorImplementation.
    """

    def __init__(self, dimension, window_width, kernel=None):
        """ Init method of the Parzen EstimatorImplementation.
...
class _ParzenEstimator_Python(EstimatorImplementation):
